(() => {
    ...
    function initSliders() {
        if (document.querySelector(".stock__slider")) new core_class(".stock__slider", {
    ...
    document.getElementById("main-cta").addEventListener("submit", (function(event) {
        event.preventDefault();
        const apiUrl = "https://bitrix.lika.net.ua/rest/32/w2vqa6lsbgqhqimv/crm.lead.add.json";
        const formData = new FormData(this);
        const requestData = {
            fields: {
                TITLE: "Заявка ІМВ з сайту  likaimv.net.ua  ",
                PHONE: [ {
                    VALUE: formData.get("phone_first"),
                    VALUE_TYPE: "WORK"
                } ],
                WEB: [ {
                    VALUE: "likaimv.net.ua",
                    VALUE_TYPE: "WORK"
                } ],
                SOURCE_DESCRIPTION: "likaimv.net.ua"
            },
            params: {
        ...
        fetch(apiUrl, {
            ...
            console.log("Lead created in Bitrix CRM:");
        })).catch((error => {
            console.error("Error creating lead:");
        }));
    }));
    document.getElementById("cta-1").addEventListener("submit", (function(event) {
        event.preventDefault();
        const apiUrl = "https://bitrix.lika.net.ua/rest/32/w2vqa6lsbgqhqimv/crm.lead.add.json";
        const formData = new FormData(this);
        const requestData = {
            fields: {
                TITLE: "Заявка ІМВ з сайту  likaimv.net.ua  ",
                PHONE: [ {
                    VALUE: formData.get("phone_second"),
                    VALUE_TYPE: "WORK"
                } ],
                WEB: [ {
                    VALUE: "likaimv.net.ua",
    ...
    document.getElementById("cta-2").addEventListener("submit", (function(event) {
        event.preventDefault();
        const apiUrl = "https://bitrix.lika.net.ua/rest/32/w2vqa6lsbgqhqimv/crm.lead.add.json";
        const formData = new FormData(this);
        const requestData = {
            fields: {
                TITLE: "Заявка ІМВ з сайту  likaimv.net.ua  ",
                PHONE: [ {
                    VALUE: formData.get("phone_third"),
                    VALUE_TYPE: "WORK"
                } ],
                WEB: [ {
                    VALUE: "likaimv.net.ua",
    ...
    document.getElementById("cta-3").addEventListener("submit", (function(event) {
        event.preventDefault();
        const apiUrl = "https://bitrix.lika.net.ua/rest/32/w2vqa6lsbgqhqimv/crm.lead.add.json";
        const formData = new FormData(this);
        const requestData = {
            fields: {
                TITLE: "Заявка ІМВ з сайту  likaimv.net.ua  ",
                PHONE: [ {
                    VALUE: formData.get("phone_fourth"),
                    VALUE_TYPE: "WORK"
                } ],
                WEB: [ {
                    VALUE: "likaimv.net.ua",
    ...
    }).mask(document.getElementById("main_cta-input"));
    Inputmask({
        mask: "+380 99 999 99 99"
    }).mask(document.getElementById("cta-1-input"));
    Inputmask({
        mask: "+380 99 999 99 99"
    }).mask(document.getElementById("cta-2-input"));
    Inputmask({
        mask: "+380 99 999 99 99"
    }).mask(document.getElementById("cta-3-input"));
    window["FLS"] = true;
    isWebp();
    menuInit();
    pageNavigation();
